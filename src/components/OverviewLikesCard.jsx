...
const OverviewLikesCard = ({icon, likes, likesChange, socialMedia, category }) => {
  ...
  let textColor = { color: likesChange < 0 ? "hsl(356, 69%, 56%)" : "hsl(163, 72%, 41%)" };
  let upOrDown =
    likesChange < 0 ? "./images/icon-down.svg" : "./images/icon-up.svg";
