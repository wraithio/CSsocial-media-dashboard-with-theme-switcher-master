...
const OverviewLikesCard = ({ socialMedia, category }) => {
  ...
  let textColor = { color: data.likeschange < 0 ? "hsl(356, 69%, 56%)" : "hsl(163, 72%, 41%)" };
  let upOrDown =
  ...
  return (
    <div className="transition-all duration-500 ease-in-out bg-slate-100 hover:bg-slate-200 dark:bg-[#252a41] dark:hover:bg-[#3d476d]">
      ...
      <div className="flex justify-between px-8 pb-8">
        <h2 className="2xl:text-5xl lg:text-3xl text-5xl font-bold dark:text-white">{data.likes}</h2>
