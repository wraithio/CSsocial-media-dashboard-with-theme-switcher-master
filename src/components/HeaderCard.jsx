    ...
    <div>
      ...
      <div className="bg-slate-100 hover:bg-slate-200 dark:bg-[#252a41] dark:hover:bg-[#3d476d] transition-all duration-500 ease-in-out">
        <div className="flex justify-center gap-3 py-7">
          ...
          <h3 className="lg:text-sm text-2xl text-gray-600 dark:text-[#8b97c6]">{data.name}</h3>
        </div>
        <h1 className="2xl:text-7xl lg:text-5xl text-7xl font-bold dark:text-white">{data.followers}</h1>
