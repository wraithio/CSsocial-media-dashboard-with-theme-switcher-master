...
const OverviewViewsCard = ({icon, views, viewsChange,socialMedia, category }) => {
  ...
  let textColor = { color: viewsChange < 0 ? "hsl(356, 69%, 56%)" : "hsl(163, 72%, 41%)" };
  let upOrDown =
    viewsChange < 0 ? "./images/icon-down.svg" : "./images/icon-up.svg";
